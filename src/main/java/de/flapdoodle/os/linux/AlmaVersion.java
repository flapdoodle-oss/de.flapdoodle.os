...
public enum AlmaVersion implements Version {
  ...
  AlmaVersion(Peculiarity... peculiarities) {
  ...
  static Peculiarity almaReleaseFileNameMatches(String name) {
    return OneOf.of(OsReleaseFiles.nameMatches(almaReleaseFile(), name), OsReleaseFiles.nameMatches(OsReleaseFiles.osReleaseFile(), name));
  }
